  ...
  <div class="w3-row-padding w3-margin-bottom">
    ...
    <div class="w3-quarter">
 	 ...
 	 <%
			...
			List<Order> orderlist = getOrder.getOrders();

			Iterator<Order> it_orderList = orderlist.iterator();
		%>
		<table style="width: 50%" align= "center">
			...
			<%
			int count =1;
				while (it_orderList.hasNext()) {
					Order order = new Order();
					order = it_orderList.next();
			%>

			<tr>
 				<td align= "center"><%=count %></td>
				<td align= "center"><%=order.getTable_name()%></td>
				<td align="center"><a href= "showfood.jsp?id=<%=order.getId()%>" class="btn-show">Show</a></td>
				<td align="center"><a href= "success.jsp?id=<%=order.getId()%>" class="payment_btn">Payment</a></td>
				<td align="center"><a href= "success.jsp?id=<%=order.getId()%>" class="del_btn">Cencel</a></td>
			</tr>
			<%
			count++;
				}
